...
def part1_2():
	...
	# Load the weights
	mat = scipy.io.loadmat( "/Users/rwk7t/Development/dst/courses/coursera_ml008/hw4/ex4weights.mat" )
...
def part2_6():
	...
	print "cost = ", result[1]
	print "grad = ", computeGradient(result[0], input_layer_size, hidden_layer_size, num_labels, X, y, lamda, yk, X_bias, verbose=True)
