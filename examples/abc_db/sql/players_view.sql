CREATE OR REPLACE FORCE VIEW "ABC"."PLAYERS_VIEW" ("PLAYER_ID", "PLAYER_NAME", "PLAYER_GOALS", "PLAYER_STARTS", "PLAYER_IMAGE1_ID", "PLAYER_IMAGE1_STD", "PLAYER_IMAGE1_AVG", "PLAYER_IMAGE2_ID", "PLAYER_IMAGE2_STD", "PLAYER_IMAGE2_AVG", "PLAYER_IMAGE3_ID", "PLAYER_IMAGE3_STD", "PLAYER_IMAGE3_AVG", "TEAM_ID") AS 
  select
	p.id       as player_id
